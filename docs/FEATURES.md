...
| Portrait and favicon served from this origin | ✅ | `public/images/ui/portrait.webp` (21 KB, was a 227 KB PNG on `github.com`) with a 12 KB 320w variant for phones; the favicon is a drawn `A` monogram — `favicon.svg` (285 B) for modern browsers, `favicon.png` (2 KB) as the legacy and apple-touch fallback |
