...
| Every live run is undoable | ✅ | The affected fields — exactly the ones that task declares — are snapshotted before the first token. Stop leaves what arrived, which is what "live" means, and says how much that was |
